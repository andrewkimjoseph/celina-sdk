...
export const MCP_TOOL_EVENT_BY_SDK_METHOD: Readonly<Record<string, string>> = {
  ...
  "governance.getActionableGovernanceProposals": "get_actionable_governance_proposals",
  ...
  "governance.getQueuedProposals": "get_queued_proposals",
  ...
  "staking.getGovernanceDelegates": "get_governance_delegates",
  "staking.getStakeEligibility": "get_stake_eligibility",
  "staking.getStakeEligibility.cLabs": "get_stake_eligibility",
