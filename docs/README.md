...
| Category | Examples |
|----------|----------|
| **Reads** | Token balances, Mento FX quotes, Uniswap v4 quotes, governance proposals, ENS resolution, GoodDollar whitelist/UBI eligibility, Carbon DeFi strategies/pairs/stats |
| **Estimates** | Gas for sends, FX swaps, Uniswap swaps, generic contract calls |
| **Prepare** | Unsigned tx flows for sends, Mento FX, Uniswap v4, Aave supply/withdraw, GoodDollar daily UBI claim, Carbon strategies and taker trades |
...
GoodDollar daily UBI: [GoodDollar guide](guides/gooddollar.md).
