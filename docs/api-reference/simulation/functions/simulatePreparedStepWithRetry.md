...
[@andrewkimjoseph/celina-sdk](../../README.md) / [simulation](../README.md) / simulatePreparedStepWithRetry

# Function: simulatePreparedStepWithRetry()

> **simulatePreparedStepWithRetry**(`publicClient`, `params`, `options?`, `retry?`): `Promise`\<`void`\>

Defined in: [src/simulation/simulate-prepared-step.ts:130](https://github.com/andrewkimjoseph/celina-sdk/blob/d1a92b5baf7555d6145bf2dd87e39acd80d0d9e3/src/simulation/simulate-prepared-step.ts#L130)
...
[`SimulatePreparedStepParams`](../type-aliases/SimulatePreparedStepParams.md)

### options?

[`SimulatePreparedStepOptions`](../type-aliases/SimulatePreparedStepOptions.md)

### retry?

[`SimulatePreparedStepRetryOptions`](../type-aliases/SimulatePreparedStepRetryOptions.md)
