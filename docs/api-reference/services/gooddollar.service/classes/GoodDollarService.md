...
[@andrewkimjoseph/celina-sdk](../../../) / [services/gooddollar.service](https://github.com/andrewkimjoseph/celina-sdk/blob/main/docs/api-reference/services/gooddollar.service/README.md) / GoodDollarService

## Class: GoodDollarService

Defined in: [src/services/gooddollar.service.ts:119](https://github.com/andrewkimjoseph/celina-sdk/blob/2ff9e44d247fc85ce400a4b07de79a8872532d5d/src/services/gooddollar.service.ts#L119)
...
Defined in: [src/services/gooddollar.service.ts:122](https://github.com/andrewkimjoseph/celina-sdk/blob/2ff9e44d247fc85ce400a4b07de79a8872532d5d/src/services/gooddollar.service.ts#L122)
...
[`GoodDollarReserveSwapParams`](https://github.com/andrewkimjoseph/celina-sdk/blob/main/docs/api-reference/services/gooddollar.service/interfaces/GoodDollarReserveSwapParams.md)

**Returns**

`Promise`<{ `amountIn`: `string`; `amountOutMin`: `string`; `amountSide`: [`GoodDollarReserveAmountSide`](https://github.com/andrewkimjoseph/celina-sdk/blob/main/docs/api-reference/services/gooddollar.service/type-aliases/GoodDollarReserveAmountSide.md); `approvalGas`: `string` | `undefined`; `approvalNeeded`: `boolean`; `broker`: `"0x88de45906D4F5a57315c133620cfa484cB297541"`; `exchangeId`: `"0xba77f5c7bb3317643c6d81d1ef3f9913561741d92095f88efa402faf2cbe9124"`; `exchangeProvider`: `"0x2fFBB49055d487DdBBb0C052Cd7c2a02A7971e41"`; `expectedOut`: `string`; `from`: `` `0x${string}` ``; `network`: `"mainnet"`; `protocol`: `"gooddollar_reserve"`; `recipient`: `` `0x${string}` ``; `routeHops`: `number`; `slippageTolerance`: `number`; `swapGas`: `string`; `tokenIn`: `string`; `tokenOut`: `string`; `totalGas`: `string`; }>
...
Defined in: [src/services/gooddollar.service.ts:246](https://github.com/andrewkimjoseph/celina-sdk/blob/2ff9e44d247fc85ce400a4b07de79a8872532d5d/src/services/gooddollar.service.ts#L246)
...
> **getReserveQuote**(`tokenIn`, `tokenOut`, `amount`, `options?`): `Promise`<{ `amountIn`: `string`; `amountSide`: [`GoodDollarReserveAmountSide`](https://github.com/andrewkimjoseph/celina-sdk/blob/main/docs/api-reference/services/gooddollar.service/type-aliases/GoodDollarReserveAmountSide.md); `broker`: `"0x88de45906D4F5a57315c133620cfa484cB297541"`; `exchangeId`: `"0xba77f5c7bb3317643c6d81d1ef3f9913561741d92095f88efa402faf2cbe9124"`; `exchangeProvider`: `"0x2fFBB49055d487DdBBb0C052Cd7c2a02A7971e41"`; `expectedOut`: `string`; `network`: `"mainnet"`; `protocol`: `"gooddollar_reserve"`; `routeHops`: `number`; `tokenIn`: `string`; `tokenOut`: `string`; }>

Defined in: [src/services/gooddollar.service.ts:641](https://github.com/andrewkimjoseph/celina-sdk/blob/2ff9e44d247fc85ce400a4b07de79a8872532d5d/src/services/gooddollar.service.ts#L641)

Expected GoodDollar reserve output for G$ ↔ USDm — no wallet required. Balance checks run on prepare/estimate only.
...
[`GoodDollarReserveQuoteOptions`](https://github.com/andrewkimjoseph/celina-sdk/blob/main/docs/api-reference/services/gooddollar.service/interfaces/GoodDollarReserveQuoteOptions.md)

**Returns**

`Promise`<{ `amountIn`: `string`; `amountSide`: [`GoodDollarReserveAmountSide`](https://github.com/andrewkimjoseph/celina-sdk/blob/main/docs/api-reference/services/gooddollar.service/type-aliases/GoodDollarReserveAmountSide.md); `broker`: `"0x88de45906D4F5a57315c133620cfa484cB297541"`; `exchangeId`: `"0xba77f5c7bb3317643c6d81d1ef3f9913561741d92095f88efa402faf2cbe9124"`; `exchangeProvider`: `"0x2fFBB49055d487DdBBb0C052Cd7c2a02A7971e41"`; `expectedOut`: `string`; `network`: `"mainnet"`; `protocol`: `"gooddollar_reserve"`; `routeHops`: `number`; `tokenIn`: `string`; `tokenOut`: `string`; }>
...
Defined in: [src/services/gooddollar.service.ts:306](https://github.com/andrewkimjoseph/celina-sdk/blob/2ff9e44d247fc85ce400a4b07de79a8872532d5d/src/services/gooddollar.service.ts#L306)

Daily UBI claim eligibility for a wallet against UBISchemeV2 on Celo. Resolves connected wallets via Identity `getWhitelistedRoot`.
...
Defined in: [src/services/gooddollar.service.ts:289](https://github.com/andrewkimjoseph/celina-sdk/blob/2ff9e44d247fc85ce400a4b07de79a8872532d5d/src/services/gooddollar.service.ts#L289)

GoodDollar IdentityV4 whitelist status and reverification progress for a wallet. Resolves connected wallets via Identity `getWhitelistedRoot`.
...
Defined in: [src/services/gooddollar.service.ts:477](https://github.com/andrewkimjoseph/celina-sdk/blob/2ff9e44d247fc85ce400a4b07de79a8872532d5d/src/services/gooddollar.service.ts#L477)

Build an unsigned UBISchemeV2 `claim()` transaction for daily G$ UBI. Validates whitelist, entitlement, and simulates gas before returning steps.
...
Defined in: [src/services/gooddollar.service.ts:863](https://github.com/andrewkimjoseph/celina-sdk/blob/2ff9e44d247fc85ce400a4b07de79a8872532d5d/src/services/gooddollar.service.ts#L863)
