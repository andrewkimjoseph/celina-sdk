...
[@andrewkimjoseph/celina-sdk](../../README.md) / [index](../README.md) / deriveSmartAccountAddress

# Function: deriveSmartAccountAddress()

> **deriveSmartAccountAddress**(`owner`, `publicClient?`): `Promise`\<\{ `eoaAddress`: `` `0x${string}` ``; `smartAccountAddress`: `` `0x${string}` ``; \}\>

Defined in: [src/aa/create-aa-client.ts:44](https://github.com/andrewkimjoseph/celina-sdk/blob/05b12850b58b19da260eb6f15b5b4dc39f45d761/src/aa/create-aa-client.ts#L44)
...
`Promise`\<\{ `eoaAddress`: `` `0x${string}` ``; `smartAccountAddress`: `` `0x${string}` ``; \}\>
